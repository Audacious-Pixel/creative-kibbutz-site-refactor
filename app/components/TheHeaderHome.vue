<template>
    <header class="bg-white sticky top-0 z-50" :style="headerStyle">
        <UContainer>
            <!-- Desktop Header -->
            <div class="hidden md:block relative" :style="{ height: headerHeight }">
                <!-- Logo - uses transform for smooth animation -->
                <div class="absolute will-change-transform" :style="logoWrapperStyle">
                    <NuxtLink to="/" class="block">
                        <img src="@/assets/img/logo.svg" alt="Creative Kibbutz" class="h-auto w-[85vw] max-w-4xl" />
                    </NuxtLink>
                </div>

                <!-- Navigation -->
                <nav class="absolute flex items-center gap-6 text-sm will-change-transform" :style="navStyle">
            ...
            <div class="flex items-center justify-between w-full md:hidden py-3">
                <NuxtLink to="/" class="flex items-center">
                    <img src="@/assets/img/logo.svg" alt="Creative Kibbutz" class="h-10 w-auto" />
                </NuxtLink>
            ...
            <div v-if="isMobileMenuOpen" class="md:hidden py-4 border-t border-gray-200">
                <nav class="flex flex-col gap-4">
                    ...
                    <a
                        ...
                        @click.prevent="
                            scrollToComponent('homePortfolio');
